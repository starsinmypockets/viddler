require(['viddler-events'], function(Events) {
...
(function (Popcorn) {
  ...
  Events.on('playerReady:m4v', function(ime, opts) {
    if (Modernizr.video.h264 && opts.mediaEl.subtitleSrc && window.Popcorn) {
        var pop = new Popcorn(ime.el);
        pop.parseSRT(opts.mediaEl.subtitleSrc);
        Events.once('timelineStep', function() {
          Popcorn.destroy(pop);
        });
    }
  });
